...
mlab.clf(fig1)
mlab.points3d(x_helm, y_helm, z_helm, scale_factor=0.02, color=(0, 0, 0))
mlab.points3d(x_helm[sens_indx], y_helm[sens_indx], z_helm[sens_indx], scale_factor=0.02, color=(0, 1, 0))
